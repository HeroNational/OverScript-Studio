    ...
    return _then(_value.copyWith(
      ...
      contentType: null == contentType
          ...
          : contentType // ignore: cast_nullable_to_non_nullable
              as PlaybackContentType,
      isLoadingPdf: null == isLoadingPdf
          ? _value.isLoadingPdf
          : isLoadingPdf // ignore: cast_nullable_to_non_nullable
              as bool,
      pdfPages: freezed == pdfPages
          ? _value.pdfPages
          : pdfPages // ignore: cast_nullable_to_non_nullable
              as List<Uint8List>?,
...
class _$PlaybackStateImpl implements _PlaybackState {
  ...
  final List<Uint8List>? _pdfPages;
  @override
  List<Uint8List>? get pdfPages {
    final value = _pdfPages;
    if (value == null) return null;
    if (_pdfPages is EqualUnmodifiableListView) return _pdfPages;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isLoadingPdf, isLoadingPdf) ||
                other.isLoadingPdf == isLoadingPdf) &&
            const DeepCollectionEquality().equals(other._pdfPages, _pdfPages) &&
